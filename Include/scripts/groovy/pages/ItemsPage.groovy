...
public class ItemsPage {
	...
	public String getTextFromItem() {
		...
		String itemName = Mobile.getText(findTestObject('Object Repository/TaskRepo/airJordan4RetroTxt'), GlobalVariable.TimeOut)
		return itemName
	}

	def clickOnAddToCartButton(){
		Mobile.tap(findTestObject('TaskRepo/AddToCart/addToCartTxt-AirJordan4Reto'), GlobalVariable.TimeOut)
	}

	def clickOnCartButton(){
